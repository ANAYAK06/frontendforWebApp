...
import { FaSearch, FaFileAlt, FaBuilding, FaCalendar, FaMoneyBill, FaTrophy } from 'react-icons/fa';
import { fetchTendersForFinalStatus } from '../../Slices/projectModuleSlices/tenderFinalStatus';
import { clearErrors } from '../../Slices/projectModuleSlices/tenderFinalStatus';
import { showToast } from '../../utilities/toastUtilities';

const TenderStatusList = ({ onSelectBOQ }) => {
    const dispatch = useDispatch();
    const { 
        tendersForFinalStatus,
        loading: { fetchTenders: loading },
        error: { fetchTenders: error }
    } = useSelector(state => state.tenderStatus);
    const [searchTerm, setSearchTerm] = useState('');

    useEffect(() => {
        dispatch(fetchTendersForFinalStatus());
    ...
    const filteredBOQs = tendersForFinalStatus?.filter(boq =>
        ...
        <div className="p-6">
            ...
            <div className="flex justify-between items-center mb-6">
                <div className="flex items-center space-x-2">
                    <FaTrophy className="text-indigo-600 w-6 h-6" />
                    <h2 className="text-xl font-semibold text-gray-900">Tender Status Update</h2>
                </div>
